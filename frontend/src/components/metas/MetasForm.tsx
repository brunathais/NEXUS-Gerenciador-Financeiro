    ...
    return (
        <div className="meta-form">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <select id="categoria" value={categoria} onChange={e => setCategoria(e.target.value as any)}>
                ...
                <label htmlFor='valor-mensal'>Contribuição mensal (R$)</label>
                <input type="number" step="0.01" value={contribuicaoMensal} onChange={e => setContribuicaoMensal(e.target.value)} />

                <label htmlFor='deposito-extra'>Depósitos extras permitidos</label> {/** talvez deixar por dafault como permitido */}
                <input type="checkbox" checked={permiteDepositosExtras} onChange={e => setPermiteDepositosExtras(e.target.checked)} />

                <label htmlFor='recorrencia'>Recorrência</label> {/** não seria obrigatorio */}
                ...
                <label htmlFor='visibilidade'>Visibilidade</label> {/** aqui teria que ver sobre as outras contas cadastradas */}
